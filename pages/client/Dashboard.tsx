  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Novos Leads" value="145" change="+12.5%" icon={Users} trend="up" />
        <StatCard title="Mensagens Trocadas" value="2,840" change="+5.2%" icon={MessageSquare} trend="up" />
        <StatCard title="Vendas Totais" value="R$ 42.500" change="+18.2%" icon={DollarSign} trend="up" />
        <StatCard title="Taxa de Resposta" value="94.2%" change="-1.1%" icon={Activity} trend="down" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Performance de Vendas</h3>
          <div className="h-80">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Volume de Mensagens</h3>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f3f4f6" />
